<div class="vls-gf-tab-container">
    <form id="vls-gf-item-details">
        ...
        <div class="vls-gf-tab-container-main">
            ...
            <label class="vls-gf-form-element">
                <span><?php _e('Pagination type', VLS_GF_TEXTDOMAIN); ?></span>
                <select name="pagination_type" class="vls-gf-half">
                    <option
                        value="global" <?php echo ("global" == $item_meta['pagination_type']) ? 'selected' : ''; ?>><?php _e('Use global setting', VLS_GF_TEXTDOMAIN); ?></option>
                    <option
                        value="none" <?php echo ("none" == $item_meta['pagination_type']) ? 'selected' : ''; ?>><?php _e('None', VLS_GF_TEXTDOMAIN); ?></option>
                    <option
	                    value="paged-numbers" <?php echo ( "paged-numbers" == $item_meta['pagination_type'] ) ? 'selected' : ''; ?>><?php _e( 'Paged (numbers)', VLS_GF_TEXTDOMAIN ); ?></option>
                    <option
                        value="paged-bullets" <?php echo ("paged-bullets" == $item_meta['pagination_type']) ? 'selected' : ''; ?>><?php _e('Paged (bullets)', VLS_GF_TEXTDOMAIN); ?></option>
                    <option
                        value="load-more" <?php echo ("load-more" == $item_meta['pagination_type']) ? 'selected' : ''; ?>><?php _e('Load more button', VLS_GF_TEXTDOMAIN); ?></option>
                    <option
                        value="load-scroll" <?php echo ("load-scroll" == $item_meta['pagination_type']) ? 'selected' : ''; ?>><?php _e('Load on scroll', VLS_GF_TEXTDOMAIN); ?></option>
                </select>
            </label>

            <label class="vls-gf-form-element">
                <span><?php _e('Page size (in rows), set 0 to use global setting', VLS_GF_TEXTDOMAIN); ?></span>
                <input type="number" name="pagination_page_size" class="vls-gf-half"
                       value="<?php echo $item_meta['pagination_page_size']; ?>"/>
            </label>

            <label class="vls-gf-form-element">
                <span><?php _e('Pagination style', VLS_GF_TEXTDOMAIN); ?></span>
                <select name="pagination_style" class="vls-gf-half">
                    <option
                        value="global" <?php echo ("global" == $item_meta['pagination_style']) ? 'selected' : ''; ?>><?php _e('Use global setting', VLS_GF_TEXTDOMAIN); ?></option>
                    <option
                        value="light" <?php echo ("light" == $item_meta['pagination_style']) ? 'selected' : ''; ?>><?php _e('Light', VLS_GF_TEXTDOMAIN); ?></option>
                    <option
                        value="dark" <?php echo ("dark" == $item_meta['pagination_style']) ? 'selected' : ''; ?>><?php _e('Dark', VLS_GF_TEXTDOMAIN); ?></option>
                    <option
                        value="custom" <?php echo ("custom" == $item_meta['pagination_style']) ? 'selected' : ''; ?>><?php _e('Custom', VLS_GF_TEXTDOMAIN); ?></option>
                </select>
            </label>
