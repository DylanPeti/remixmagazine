...
VLS_GF.TourModule = (function ($) {
    ...
    function close() {
        ...
        $('.vls-gf-fixed-items .vls-gf-unsorted a').trigger('click');
    ...
    function next() {
        ...
        currentStep++;
        $tour.find('.vls-gf-tour-progress span').eq(currentStep).addClass('done');
    ...
    var showStep = [
        ...
        //1: navigating folders and albums
        function () {
            ...
            setTimeout(function () {
                $('#vls-gf-gallery-tree .vls-gf-folder.level-1:eq(0)').trigger('click');
                setTimeout(function () {
                    $('#vls-gf-gallery-tree .vls-gf-folder.level-2:eq(1)').trigger('click');
                    setTimeout(function () {
        ...
        function () {
            ...
            setTimeout(function () {
                ...
                setTimeout(function () {
                    $('#vls-gf-gallery-tree .vls-gf-folder.level-2:eq(1)').trigger('click');
                    setTimeout(function () {
                        $('#vls-gf-gallery-tree .vls-gf-album.level-3:eq(0)').trigger('click');
    ...
    function backdrop() {
        ...
        for (var i = 1; i <= showStep.length; i++) {
