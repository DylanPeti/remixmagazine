...
if ( ! class_exists( "VLS_Gallery_Factory_Admin_AJAX" ) ) {
	class VLS_Gallery_Factory_Admin_AJAX {
		...
		public function init() {
			...
			//tools
			add_action( 'wp_ajax_vls_gf_import_wp_media_batch', array( $this, 'import_wp_media_batch' ) );
		...
		public function update_album_details() {
			...
			$pagination_page_size        = absint( $_POST['pagination_page_size'] );
...
//					array_push( $items, $item );
		...
		public function update_image_details() {
			...
			// save link-specific settings
			if ( array_key_exists( 'link_id', $_POST ) ) {
				$link_id = intval( $_POST['link_id'] );
				switch ( $_POST['click_action'] ) {
					case 'redirect':
				...
				update_post_meta( $link_id, '_vls_gf_image_meta', array(
		...
		/**
		 * Imports one batch of WP Media images
		 */
		public function import_wp_media_batch() {
			...
			$response = array(
				'result' => 'ok',
				'haveNextBatch'   => (count($posts) == $batch_size),
				'data'   => ''
			);
			...
			if ($batch_no == 1) {
				$response['totalCount'] = $wpdb->get_var(
					$wpdb->prepare( "
                        SELECT COUNT(*)
                        FROM $wpdb->posts p
                        WHERE p.post_type = %s
			...
			<div class="vls-gf-image-panel">
				<ul>
					...
					foreach ( $posts as $link ) {
						$n++;
						$thumbnail_url = VLS_Gallery_Factory::_get_image_url( $link->url, 'thumbnail' );
						echo( '<li data-vls-gf-image-id="' . $link->image_id . '" '
						      . ( $item_type == 'album' ? 'data-vls-gf-link-id="' . $link->link_id . '"' : '' )
						      . '><a><img '
						      . ($n <= 40
									? 'src="' . $thumbnail_url . '" '
									: 'src="' . VLS_GF_PLUGIN_URL . '/frontend/img/null.gif" data-original="' . $thumbnail_url . '" ')
						      .'/></a></li>' );
					}
		...
		private function output_folder_items( $level_no, $parent_id ) {
			...
			foreach ( $posts as $post ) {
				...
				if ( $post->post_type == VLS_GF_POST_TYPE_FOLDER ) {
					$itemHtml .= 'vls-gf-folder '; // opened
				} else {
					$itemHtml .= 'vls-gf-album ';
				}
		...
		private function output_mockup_folder_items() {
			...
			?>
			<li class="vls-gf-folder level-1" data-vls-gf-id="1" data-vls-gf-level="1" data-vls-gf-order="00001"><a href="#"><span
						class="vls-gf-icon"></span><span class="vls-gf-label">Example folder #1</span></a></li>
			<li class="vls-gf-folder level-2" data-vls-gf-id="1"  data-vls-gf-level="2" data-vls-gf-order="00002"><a href="#"><span
						class="vls-gf-icon"></span><span class="vls-gf-label">Example subfolder #1</span></a></li>
			<li class="vls-gf-folder level-2" data-vls-gf-id="1"  data-vls-gf-level="2" data-vls-gf-order="00003"><a href="#"><span
						class="vls-gf-icon"></span><span class="vls-gf-label">Example subfolder #2</span></a></li>
			<li class="vls-gf-album level-3" data-vls-gf-id="1"  data-vls-gf-level="3" data-vls-gf-order="00004" data-vls-gf-id="tour_album"
			...
			<li class="vls-gf-album level-3" data-vls-gf-id="1"  data-vls-gf-level="3" data-vls-gf-order="00005" data-vls-gf-id="tour_album"
			    data-vls-gf-shortcode="[vls_gf_album id=&quot;42&quot;]"><a href="#"><span class="vls-gf-icon"></span><span
						class="vls-gf-label">Example album #2</span></a></li>
			<li class="vls-gf-album level-3" data-vls-gf-id="1"  data-vls-gf-level="3" data-vls-gf-order="00006" data-vls-gf-id="tour_album"
			    data-vls-gf-shortcode="[vls_gf_album id=&quot;42&quot;]"><a href="#"><span class="vls-gf-icon"></span><span
						class="vls-gf-label">Example album #3</span></a></li>
			<li class="vls-gf-folder level-1" data-vls-gf-id="1"  data-vls-gf-level="1" data-vls-gf-order="00007"><a href="#"><span
						class="vls-gf-icon"></span><span class="vls-gf-label">Example folder #2</span></a></li>
			<li class="vls-gf-folder level-1" data-vls-gf-id="1"  data-vls-gf-level="1" data-vls-gf-order="00008"><a href="#"><span
